      ...
      const rand = this.rand; rand.setSeed(se.id);
       ...
       const Room = {
           ...
           connect(to){
               ...
               this_pl.brush(intm_main_generator.pathfind(this.x, this.y, to.x, to.y, tile => (tile.solid() ? 5 : 0) + 
               this_pl.noiseOct(tile.x, tile.y, 1, 1, 1 / nscl) * 60, Astar.manhattan), stroke);
           }
       };
